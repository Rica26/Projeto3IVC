...
class Game(tk.Frame):
    ...
    def update_object_tracking(self):
        if self.cap.isOpened():
            ...
            center = (int(bbox[0] + bbox[2] * 0.5), int(bbox[1] + bbox[3] * 0.5))
            axes = (int(bbox[2] * 0.5), int(bbox[3] * 0.5))
            frame_copy = cv2.ellipse(frame_copy.copy(), center, axes, 0, 0, 360, (0, 255, 0), 2)
